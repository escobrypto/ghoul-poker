...
| P3 | **Card v2** | 🟨 interim bump shipped | hole cards 32x46→44x62, community 60x84→84x118 (+~40%), bigger ranks/suits/back sigil. Full premium redesign (typography, suit art, visual impact) still to come as the real P3. |
